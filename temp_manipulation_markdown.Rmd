...
Welcome, friends! Please go forth and scroll down to begin your journey though my data analysis for our temperature manipulation experiment. Here I have provided some basic background and performed all analyses from the hot/cold dataset. These results will be used for a manuscript in preparation for publication. Ambient temperature dataset analysis is presented elsewhere, for ease of presentation. 

![An adult red-eyed treefrog](/Users/juliejung/Documents/GitHub/temp_manipulation/img/IMG_1697.JPG){width=300px}

![A juvenile red-eyed treefrog](/Users/juliejung/Documents/GitHub/temp_manipulation/img/IMG_1666.JPG){width=300px}

Red-eyed treefrogs, *Agalychnis callidryas*, pictured as an adult (Fig. 1) and a juvenile (Fig. 2), commonly lay their eggs on leafy substrate overhanging tropical ponds (Fig. 3). 

![An arboreal clutch of red-eyed treefrog eggs](/Users/juliejung/Documents/GitHub/temp_manipulation/img/IMG_1615.JPG){width=300px}

![Leptophis or parrot snake, an egg predator](/Users/juliejung/Documents/GitHub/temp_manipulation/img/IMG_6958.JPG){width=300px}

These arboreal embryos can hatch prematurely to escape from egg predators, such as the parrot snake (Fig. 4), cued by vibrations in attacks.  
